package io.wisoft.testermatchingplatform.service.tester;//package io.wisoft.testermatchingplatform.service.tester;
//
...
//        Tester tester = testerRepository.findById(testerId).orElseThrow();
//        Test test = testRepository.findById(questApplyRequest.getQuestId()).orElseThrow();
//
...
//                null, tester, test, requireConditionSubmitPath, preferConditionSubmitPath
//        );
//

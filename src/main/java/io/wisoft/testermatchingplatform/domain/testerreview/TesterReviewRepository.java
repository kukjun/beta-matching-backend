...
import io.wisoft.testermatchingplatform.web.dto.response.maker.SimpleReviewDTO;
...
public interface TesterReviewRepository extends JpaRepository<TesterReview, UUID> {
    ...
    @Query(value = "SELECT new io.wisoft.testermatchingplatform.web.dto.response.maker.SimpleReviewDTO(t.title, tr.starPoint, tr.comment) " +
